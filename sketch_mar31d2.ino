...
void startExperiment() {
  ...
  updateDisplay(); // Call this if you want to display the settings
  // or
  updateExperimentDisplay(0, currentCycle); // Call this if you want to display the experiment progress
