...
void updateDisplay() {
  ...
  display.print("H-A Speed: "); display.print(HA_speed); display.println(" sec");
  display.print("L-A Speed: "); display.print(LA_speed); display.println(" sec");
  display.print("# of Cycles: "); display.print(numCycles); display.println();
  display.print("Pause Time: "); display.print(pauseTime); display.println(" sec");
  display.display();
}
...
void updateExperimentDisplay(unsigned long elapsedTime, int currentCycle) {
  ...
  display.print("Elapsed Time: "); display.print(elapsedTime); display.println(" sec");
  display.print("Current Cycle: "); display.print(currentCycle + 1); display.print("/"); display.print(numCycles);
  display.println();
  display.print("H-A: "); display.print(HA_speed); display.print(" sec, L-A: "); display.print(LA_speed); display.println(" sec");
  display.print("Pause: "); display.print(pauseTime); display.println(" sec");
  display.display();
}